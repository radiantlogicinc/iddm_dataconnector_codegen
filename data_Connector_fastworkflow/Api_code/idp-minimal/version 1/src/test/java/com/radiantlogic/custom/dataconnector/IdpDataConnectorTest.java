...
public class IdpDataConnectorTest {
    ...
    private IdpDataConnector connector;

    @BeforeEach
    public void setUp() {
        MockitoAnnotations.openMocks(this);
        when(mockProperties.getProperty("baseUrl", "")).thenReturn("https://api.example.com");
        connector = new IdpDataConnector(mockLogger, mockProperties);
    }
    ...
    public void testConnectionSuccess() {
        ...
        assertEquals("IdpAPI", response.getSourceName());
    }
