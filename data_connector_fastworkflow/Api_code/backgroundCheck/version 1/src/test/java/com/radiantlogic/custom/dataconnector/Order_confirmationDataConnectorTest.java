...
public class Order_confirmationDataConnectorTest {
    ...
    private Order_confirmationDataConnector connector;

    @BeforeEach
    public void setUp() {
        MockitoAnnotations.openMocks(this);
        when(mockProperties.getProperty("baseUrl", "")).thenReturn("https://api.example.com");
        connector = new Order_confirmationDataConnector(mockLogger, mockProperties);
    }
    ...
    public void testConnectionSuccess() {
        ...
        assertEquals("Order_confirmationAPI", response.getSourceName());
    }
