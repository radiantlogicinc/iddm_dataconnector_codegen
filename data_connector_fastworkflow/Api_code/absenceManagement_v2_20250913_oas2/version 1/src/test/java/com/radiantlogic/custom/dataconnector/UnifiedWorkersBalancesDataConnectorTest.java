...
public class UnifiedWorkersBalancesDataConnectorTest {
    ...
    private UnifiedWorkersBalancesDataConnector connector;

    @BeforeEach
    public void setUp() {
        MockitoAnnotations.openMocks(this);
        when(mockProperties.getProperty("baseUrl", "")).thenReturn("https://api.example.com");
        connector = new UnifiedWorkersBalancesDataConnector(mockLogger, mockProperties);
    }
    ...
    public void testConnectionSuccess() {
        ...
        assertEquals("UnifiedWorkersBalancesAPI", response.getSourceName());
    }
