...
/**
 * Gets or Sets OktaKprEnum
 */
public enum OktaKprEnum {
  ...
  @JsonCreator
  public static OktaKprEnum fromValue(String value) {
    for (OktaKprEnum b : OktaKprEnum.values()) {
