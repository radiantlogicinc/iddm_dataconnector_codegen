 ...
 */
@JsonPropertyOrder({
  ReplacePasswordRequestProfile.JSON_PROPERTY_PASSWORD
})
@JsonTypeName("replacePassword_request_profile")
...
public class ReplacePasswordRequestProfile {
  public static final String JSON_PROPERTY_PASSWORD = "password";
  @javax.annotation.Nonnull
  private String password;

  public ReplacePasswordRequestProfile() {
  }

  public ReplacePasswordRequestProfile password(@javax.annotation.Nonnull String password) {
  ...
  public boolean equals(Object o) {
    ...
    ReplacePasswordRequestProfile replacePasswordRequestProfile = (ReplacePasswordRequestProfile) o;
    return Objects.equals(this.password, replacePasswordRequestProfile.password);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReplacePasswordRequestProfile {\n");
