...
import com.okta.myaccount.myaccountmanagement.model.EmailLinksSelfHints;
 ...
 */
@JsonPropertyOrder({
  EmailLinksSelf.JSON_PROPERTY_HREF,
  EmailLinksSelf.JSON_PROPERTY_HINTS
})
@JsonTypeName("Email__links_self")
...
public class EmailLinksSelf {
  ...
  @javax.annotation.Nullable
  private EmailLinksSelfHints hints;

  public EmailLinksSelf() {
  }

  public EmailLinksSelf href(@javax.annotation.Nullable String href) {
  ...
  public EmailLinksSelf hints(@javax.annotation.Nullable EmailLinksSelfHints hints) {
  ...
  public EmailLinksSelfHints getHints() {
    return hints;
  }
  ...
  @JsonProperty(JSON_PROPERTY_HINTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHints(@javax.annotation.Nullable EmailLinksSelfHints hints) {
    this.hints = hints;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmailLinksSelf emailLinksSelf = (EmailLinksSelf) o;
    return Objects.equals(this.href, emailLinksSelf.href) &&
        Objects.equals(this.hints, emailLinksSelf.hints);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailLinksSelf {\n");
