 ...
 */
@JsonPropertyOrder({
  AppAuthenticatorEnrollmentLinksSelfHints.JSON_PROPERTY_ALLOW
})
@JsonTypeName("AppAuthenticatorEnrollment_links_self_hints")
...
public class AppAuthenticatorEnrollmentLinksSelfHints {
  /**
   * Gets or Sets allow
   */
  ...
  public AppAuthenticatorEnrollmentLinksSelfHints() {
  }

  public AppAuthenticatorEnrollmentLinksSelfHints allow(@javax.annotation.Nullable List<AllowEnum> allow) {
    
    this.allow = allow;
    return this;
  }

  public AppAuthenticatorEnrollmentLinksSelfHints addAllowItem(AllowEnum allowItem) {
    if (this.allow == null) {
  ...
  public boolean equals(Object o) {
    ...
    AppAuthenticatorEnrollmentLinksSelfHints appAuthenticatorEnrollmentLinksSelfHints = (AppAuthenticatorEnrollmentLinksSelfHints) o;
    return Objects.equals(this.allow, appAuthenticatorEnrollmentLinksSelfHints.allow);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppAuthenticatorEnrollmentLinksSelfHints {\n");
