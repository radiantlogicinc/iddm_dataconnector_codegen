...
import com.okta.myaccount.myaccountmanagement.model.OrganizationLinksSelf;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;
import com.okta.myaccount.myaccountmanagement.invoker.JacksonConfig;

/**
 * Discoverable resources related to the org
 */
@JsonPropertyOrder({
  OrganizationLinks.JSON_PROPERTY_SELF
})
@JsonTypeName("Organization__links")
...
public class OrganizationLinks {
  ...
  private OrganizationLinksSelf self;

  public OrganizationLinks() {
  }

  public OrganizationLinks self(@javax.annotation.Nullable OrganizationLinksSelf self) {
  ...
  public OrganizationLinksSelf getSelf() {
    return self;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SELF)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSelf(@javax.annotation.Nullable OrganizationLinksSelf self) {
    this.self = self;
  }
