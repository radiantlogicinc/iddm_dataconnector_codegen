...
import com.okta.myaccount.myaccountmanagement.model.HttpMethod;
 ...
 */
@JsonPropertyOrder({
  HrefObjectHints.JSON_PROPERTY_ALLOW
})
...
public class HrefObjectHints {
  ...
  private List<HttpMethod> allow = new ArrayList<>();

  public HrefObjectHints() {
  }

  public HrefObjectHints allow(@javax.annotation.Nullable List<HttpMethod> allow) {
  ...
  @JsonProperty(JSON_PROPERTY_ALLOW)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAllow(@javax.annotation.Nullable List<HttpMethod> allow) {
    this.allow = allow;
  }
  ...
  public boolean equals(Object o) {
    ...
    HrefObjectHints hrefObjectHints = (HrefObjectHints) o;
    return Objects.equals(this.allow, hrefObjectHints.allow);
  }
