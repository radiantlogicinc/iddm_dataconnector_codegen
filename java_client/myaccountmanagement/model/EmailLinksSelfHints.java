 ...
 */
@JsonPropertyOrder({
  EmailLinksSelfHints.JSON_PROPERTY_ALLOW
})
@JsonTypeName("Email__links_self_hints")
...
public class EmailLinksSelfHints {
  /**
   * Gets or Sets allow
   */
  ...
  public EmailLinksSelfHints() {
  }

  public EmailLinksSelfHints allow(@javax.annotation.Nullable List<AllowEnum> allow) {
    
    this.allow = allow;
    return this;
  }

  public EmailLinksSelfHints addAllowItem(AllowEnum allowItem) {
    if (this.allow == null) {
  ...
  public boolean equals(Object o) {
    ...
    EmailLinksSelfHints emailLinksSelfHints = (EmailLinksSelfHints) o;
    return Objects.equals(this.allow, emailLinksSelfHints.allow);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailLinksSelfHints {\n");
