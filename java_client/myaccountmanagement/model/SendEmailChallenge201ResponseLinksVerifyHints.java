 ...
 */
@JsonPropertyOrder({
  SendEmailChallenge201ResponseLinksVerifyHints.JSON_PROPERTY_ALLOW
})
@JsonTypeName("sendEmailChallenge_201_response__links_verify_hints")
...
public class SendEmailChallenge201ResponseLinksVerifyHints {
  /**
   * Gets or Sets allow
   */
  ...
  public SendEmailChallenge201ResponseLinksVerifyHints() {
  }

  public SendEmailChallenge201ResponseLinksVerifyHints allow(@javax.annotation.Nonnull List<AllowEnum> allow) {
    
    this.allow = allow;
    return this;
  }

  public SendEmailChallenge201ResponseLinksVerifyHints addAllowItem(AllowEnum allowItem) {
    if (this.allow == null) {
  ...
  public boolean equals(Object o) {
    ...
    SendEmailChallenge201ResponseLinksVerifyHints sendEmailChallenge201ResponseLinksVerifyHints = (SendEmailChallenge201ResponseLinksVerifyHints) o;
    return Objects.equals(this.allow, sendEmailChallenge201ResponseLinksVerifyHints.allow);
  }
  ...
  public String toString() {
    ...
    sb.append("class SendEmailChallenge201ResponseLinksVerifyHints {\n");
