 ...
 */
@JsonPropertyOrder({
  OrganizationLinksSelfHints.JSON_PROPERTY_ALLOW
})
@JsonTypeName("Organization__links_self_hints")
...
public class OrganizationLinksSelfHints {
  /**
   * Gets or Sets allow
   */
  ...
  public OrganizationLinksSelfHints() {
  }

  public OrganizationLinksSelfHints allow(@javax.annotation.Nullable List<AllowEnum> allow) {
    
    this.allow = allow;
    return this;
  }

  public OrganizationLinksSelfHints addAllowItem(AllowEnum allowItem) {
    if (this.allow == null) {
  ...
  public boolean equals(Object o) {
    ...
    OrganizationLinksSelfHints organizationLinksSelfHints = (OrganizationLinksSelfHints) o;
    return Objects.equals(this.allow, organizationLinksSelfHints.allow);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationLinksSelfHints {\n");
