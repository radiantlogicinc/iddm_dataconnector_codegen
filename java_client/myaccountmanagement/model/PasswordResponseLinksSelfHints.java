 ...
 */
@JsonPropertyOrder({
  PasswordResponseLinksSelfHints.JSON_PROPERTY_ALLOW
})
@JsonTypeName("PasswordResponse__links_self_hints")
...
public class PasswordResponseLinksSelfHints {
  /**
   * Gets or Sets allow
   */
  ...
  public PasswordResponseLinksSelfHints() {
  }

  public PasswordResponseLinksSelfHints allow(@javax.annotation.Nullable List<AllowEnum> allow) {
    
    this.allow = allow;
    return this;
  }

  public PasswordResponseLinksSelfHints addAllowItem(AllowEnum allowItem) {
    if (this.allow == null) {
  ...
  public boolean equals(Object o) {
    ...
    PasswordResponseLinksSelfHints passwordResponseLinksSelfHints = (PasswordResponseLinksSelfHints) o;
    return Objects.equals(this.allow, passwordResponseLinksSelfHints.allow);
  }
  ...
  public String toString() {
    ...
    sb.append("class PasswordResponseLinksSelfHints {\n");
